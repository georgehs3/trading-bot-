...
class NewsRanking:
    ...
    def __init__(self, config):
        ...
        self.high_risk_terms = ["SEC investigation", "lawsuit", "fraud", "regulatory action"]
    ...
    def calculate_trade_influence_score(self, news_data):
        ...
        for news in news_data:
            ...
            recency_weight = max(0, 1 - (news_age / self.time_decay_days))  # Decays over a week
            
            # Source Credibility
            credibility_weight = 1.0 if news["source"] in self.credible_sources else 0.5
            
            # Historical Impact (earnings and major company news have stronger influence)
...
if __name__ == "__main__":
    ...
    sample_news = [
        {"headline": "Company X reports record earnings growth", "source": "Bloomberg", "date": datetime.datetime.utcnow()},
        {"headline": "SEC investigation launched into Company Y", "source": "Unknown", "date": datetime.datetime.utcnow()},
    ]
